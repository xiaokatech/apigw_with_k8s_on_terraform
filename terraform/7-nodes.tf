...
resource "aws_iam_role_policy_attachment" "amazon-ec2-continaer-registry-read-only" {
...
resource "aws_eks_node_group" "private-nodes" {
  ...
  node_role_arn   = aws_iam_role.nodes
  ...
  depends_on = [
    aws_iam_role_policy_attachment.amazon-ec2-continaer-registry-read-only,
